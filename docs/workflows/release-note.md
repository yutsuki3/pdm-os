...
5. **公開**
   承認されたリリースノートを公開する。社内向けと顧客向けを別々に作成し、社内向けはSlackチャンネル、顧客向けはNotion公開ページへ公開する。過去のリリースノートはNotion（現行仕様と同じ場所）にアーカイブする。
...
| 公開 | 承認済み草稿 | 社内: Slackチャンネルへの投稿。顧客向け: Notion公開ページへの公開 |

## 未確定事項

- 具体的なSlackチャンネル名・Notion公開ページのフォーマット
